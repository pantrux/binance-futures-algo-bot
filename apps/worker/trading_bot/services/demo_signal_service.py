    ...
    def build_signal_pack(self, symbol: str) -> tuple[SignalPack, MarketContext, str, dict[str, float]]:
        presets = {
            "BTCUSDT": {
                ...
                "context": MarketContext(symbol="BTCUSDT", timeframe="15m", volatility_pct=2.7, trend_strength=74, liquidity_score=93, last_candle_close_ms=0),
            ...
            "SOLUSDT": {
                ...
                "context": MarketContext(symbol="SOLUSDT", timeframe="15m", volatility_pct=3.1, trend_strength=65, liquidity_score=86, last_candle_close_ms=0),
