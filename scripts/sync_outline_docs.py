...
NON_ADR_TITLE_MAP = {
    ...
    "docs/plans/transition-checklist-and-capital-ramp.md": f"{PREFIX} — Checklist de transición y rampa de capital",
    "docs/plans/cutover-and-post-cutover-monitoring.md": f"{PREFIX} — Cutover y monitoreo post-cutover",
    "docs/plans/cutover-drills-and-evidence-package.md": f"{PREFIX} — Drills de cutover y paquete de evidencia",
