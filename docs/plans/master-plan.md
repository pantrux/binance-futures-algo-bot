...
- Carril inmediato (`PR-112`): exponer en el summary del drawer cuándo corrió el último `reconcile now`, para que el operador no vea un estado healthy/drift sin referencia temporal.
