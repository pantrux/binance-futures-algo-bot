...
- PR-53 en adelante.
- Estado actual: en progreso (`PR-53`..`PR-59` mergeados; `PR-60` activo para auto-ingestar mercado en Synology antes del fallback demo y cerrar la raíz de `snapshot_incompleto`).
