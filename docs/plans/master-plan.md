...
- Carril inmediato (`PR-111`): dejar una nota efímera cuando la apertura/cierre de drawers cambie el scope live efectivo, para que el operador perciba el cambio del universo live sin tener que comparar manualmente chips o contadores.
