...
- Carril inmediato (`PR-113`): mostrar también la referencia temporal del snapshot cuando todavía no hubo `reconcile now`, para que el summary del drawer nunca quede sin contexto temporal.
