...
| PR-88 | Breakdown por timeframe en shadow-run symbols | 🟡 En progreso | evitar que `symbols` agregue bajo una sola fila reportes de un mismo símbolo que pertenecen a temporalidades distintas |
